...
{
    static class GetFeedCustomDataAsyncExample
    {
        public static async Task Run(GeotabDataOnlyPlanAPI api)
        {
            ConsoleUtility.LogExampleStarted(typeof(GetFeedCustomDataAsyncExample).Name);
            ...
            try
            {
                ...
                long? feedVersion;
                FeedResult<CustomData> feedResult;
                ...
                feedResult = await api.GetFeedCustomDataAsync(getFeedStartTime, getFeedresultsLimit);
                ...
                {
                    // Make GetFeed call.
                    feedResult = await api.GetFeedCustomDataAsync(feedVersion, getFeedresultsLimit);
                    feedVersion = feedResult.ToVersion;
            ...
            ConsoleUtility.LogExampleFinished(typeof(GetFeedCustomDataAsyncExample).Name);
        }
    }
}