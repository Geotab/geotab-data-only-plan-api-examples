...
{
    static class GetFeedStatusDataAsyncExample
    {
        public static async Task Run(GeotabDataOnlyPlanAPI api)
        {
            ConsoleUtility.LogExampleStarted(typeof(GetFeedStatusDataAsyncExample).Name);
            ...
            try
            {
                ...
                long? feedVersion;
                FeedResult<StatusData> feedResult;
                ...
                feedResult = await api.GetFeedStatusDataAsync(getFeedStartTime, getFeedresultsLimit);
                ...
                {
                    // Make GetFeed call.
                    feedResult = await api.GetFeedStatusDataAsync(feedVersion, getFeedresultsLimit);
                    feedVersion = feedResult.ToVersion;
            ...
            ConsoleUtility.LogExampleFinished(typeof(GetFeedStatusDataAsyncExample).Name);
        }
    }
}